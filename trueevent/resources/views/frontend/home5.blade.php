...
<!-- Mirrored from themewagon.github.io/logis-new/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 26 Jun 2025 15:41:47 GMT -->
...
<head>
  ...
  <link href="{{asset('public/frontend/assets/vendor/fontawesome-free/css/all.min.css')}}" rel="stylesheet">
...
<body class="index-page" >
  ...
  <header id="header" class="header d-flex align-items-center fixed-top">
    <div class="container-fluid container-xl position-relative d-flex align-items-center">
      ...
      <nav id="navmenu" class="navmenu">
        ...
        <i class="mobile-nav-toggle d-xl-none bi bi-list" id="fa"></i>
      </nav>
  ...
  <main class="main">
    ...
    <section id="hero" class="hero section dark-background">
      ...
      <img src="{{asset('public/frontend/assets/img/world-dotted-map.png')}}" alt="" class="hero-bg" data-aos="fade-in">
      ...
      <div class="container">
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-4 col-md-6 service-item d-flex" data-aos="fade-up" data-aos-delay="100">
            <div class="icon flex-shrink-0"><i class="fa-solid fa-cart-flatbed" id="fa"></i></div>
            <div>
          ...
          <div class="col-lg-4 col-md-6 service-item d-flex" data-aos="fade-up" data-aos-delay="200">
            <div class="icon flex-shrink-0"><i class="fa-solid fa-truck" id="fa"></i></div>
            <div>
          ...
          <div class="col-lg-4 col-md-6 service-item d-flex" data-aos="fade-up" data-aos-delay="300">
            <div class="icon flex-shrink-0"><i class="fa-solid fa-truck-ramp-box" id="fa"></i></div>
            <div>
      ...
      <div class="container">
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-6 content order-last  order-lg-first" data-aos="fade-up" data-aos-delay="100">
            ...
            <ul>
              <li>
                <i class="bi bi-diagram-3" id="fa" ></i>
                <div>
              ...
              <li>
                <i class="bi bi-fullscreen-exit"id="fa"></i>
                <div>
              ...
              <li>
                <i class="bi bi-broadcast"id="fa"></i>
                <div>
        ...
        <div class="row justify-content-center" data-aos="zoom-in" data-aos-delay="100">
          <div class="col-xl-10">
            <div class="text-center">
              ...
              <a class="cta-btn btn btn-outline-secondary" href="#">6200272141</a>
...
<!-- Mirrored from themewagon.github.io/logis-new/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 26 Jun 2025 15:42:02 GMT -->
</html>