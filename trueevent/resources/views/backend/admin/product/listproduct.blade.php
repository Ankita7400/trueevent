...
<td> <img src="{{asset('public/'.$product->image ?: 'public/backend/assets/img/default.png') }}"  class="rounded-circle m-r-5"  width="28" height="28" > 

</td>
<td>
    
<a class="p-2 text-success" href="{{ route('admin.products.edit', $product->id) }}">Edit</a>
...
@csrf
@method('DELETE')
<a href="{{ route('admin.products.destroy', $product->id) }}" class="p-2 text-danger" onclick="return confirm('Are you sure you want to delete this Product ?')">Delete</a>
</form> 
</td>
</tr>
@endforeach
