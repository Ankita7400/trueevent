...
<input type="text" class="form-control  @error('name') is-invalid @enderror" placeholder="Enter Categories Name" name="name" value="{{ $category->name }}">
@error('title')
...
<div class="col-12 mt-3">
  ...
  <div class="row">
      ...
      <div class="col-md-3 position-relative preview-image">
          <img src="{{ asset('public/'.$category->image) }}" class="img-thumbnail mb-2" style="max-width: 100%;">
          <button type="button" class="btn btn-danger btn-remove-existing position-absolute top-0 end-0" data-id="{{ $category->id }}">X</button>
      </div>
      {{-- @endforeach --}}
  </div>
</div>
