...
<div class="ms-auto">
<div class="btn-group">
<a href="{{route('admin.service-categories.create')}}" class="btn btn-primary">Add Categories</a>
...
<h6 class="mb-0 text-uppercase">Service Categories</h6>
<hr>
<div class="card">
<div class="card-body">
...
<td>{{ $category->name }}</td>
<td>{{ $category->slug }}</td>
<td> <img src="{{asset('public/'.$category->image ?: 'public/backend/assets/img/default.png') }}"  class="rounded-circle m-r-5"  width="28" height="28" > 

</td>
  <td>{{ $category->status ? 'Active' : 'Inactive' }}</td>
<td>
    
<a class="p-2 text-success" href="{{ route('admin.service-categories.edit', $category->id) }}">Edit</a>




<form action="{{ route('admin.service-categories.destroy', $category->id) }}" method="POST" style="display:inline;">
@csrf
@method('DELETE')
<a href="{{ route('admin.service-categories.destroy', $category->id) }}" class="p-2 text-danger" onclick="return confirm('Are you sure you want to delete this Course ?')">Delete</a>
</form> 
</td>
</tr>
@endforeach
