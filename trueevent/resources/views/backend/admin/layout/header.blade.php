...
<head>
  ...
  <title>Laravel</title>
  <!--favicon-->
  <link rel="icon" href="{{asset('public/backend/admin/assets/images/favicon-32x32.png')}}" type="image/png">
  <!-- loader-->
	<link href="{{asset('public/backend/admin/assets/css/pace.min.css')}}" rel="stylesheet">

	<script src="{{asset('public/backend/admin/assets/js/pace.min.js')}}"></script>

  <!--plugins-->
  <link href="{{asset('public/backend/admin/assets/plugins/perfect-scrollbar/css/perfect-scrollbar.css')}}" rel="stylesheet">
  <link rel="stylesheet" type="text/css" href="{{asset('public/backend/admin/assets/plugins/metismenu/metisMenu.min.css')}}">
  <link rel="stylesheet" type="text/css" href="{{asset('public/backend/admin/assets/plugins/metismenu/mm-vertical.css')}}">
  <link rel="stylesheet" type="text/css" href="{{asset('public/backend/admin/assets/plugins/simplebar/css/simplebar.css')}}">
  <link href="{{asset('public/backend/admin/assets/plugins/fancy-file-uploader/fancy_fileupload.css')}}" rel="stylesheet">
	<link href="{{asset('public/backend/admin/assets/plugins/Drag-And-Drop/dist/imageuploadify.min.css')}}" rel="stylesheet">
  <!--bootstrap css-->
  <link href="{{asset('public/backend/admin/assets/css/bootstrap.min.css')}}" rel="stylesheet">
  <link href="{{asset('public/backend/admin/assets/plugins/datatable/css/dataTables.bootstrap5.min.css')}}" rel="stylesheet" />
  <link href="https://fonts.googleapis.com/css2?family=Noto+Sans:wght@300;400;500;600&amp;display=swap" rel="stylesheet">
  <link href="https://fonts.googleapis.com/css?family=Material+Icons+Outlined" rel="stylesheet">
  <!--main css-->
  <link href="{{asset('public/backend/admin/assets/css/bootstrap-extended.css')}}" rel="stylesheet">
  <link href="{{asset('public/backend/admin/sass/main.css')}}" rel="stylesheet">
  <link href="{{asset('public/backend/admin/sass/dark-theme.css')}}" rel="stylesheet">
  <link href="{{asset('public/backend/admin/sass/blue-theme.css')}}" rel="stylesheet">
  <link href="{{asset('public/backend/admin/sass/semi-dark.css')}}" rel="stylesheet">
  <link href="{{asset('public/backend/admin/sass/bordered-theme.css')}}" rel="stylesheet">
  <link href="{{asset('public/backend/admin/sass/responsive.css')}}" rel="stylesheet">
