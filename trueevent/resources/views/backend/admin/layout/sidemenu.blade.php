    ...
    <div class="sidebar-nav">
        ...
        <ul class="metismenu" id="sidenav">
          ...
          <li>
            ...
            <ul>
              <li><a href="{{route('admin.service-categories.index')}}"><i class="material-icons-outlined">arrow_right</i>Service Categories</a>
              </li>
              <li><a href="{{route('admin.sub-categories.index')}}"><i class="material-icons-outlined">arrow_right</i>Sub Categories</a>
              </li>
              <li><a href="{{route('admin.products.index')}}"><i class="material-icons-outlined">arrow_right</i>Product</a>
              </li>
            </ul>
          </li>
          ...
          <li>
            ...
            <ul>
              <li><a href="{{route('admin.contact')}}"><i class="material-icons-outlined">arrow_right</i>Contact List</a>
              </li>
          ...
          {{-- <li>
            ...
            <ul>
              <li><a href="{{ route('examseries.list') }}"><i class="material-icons-outlined">arrow_right</i>Exam Series</a>
              </li>
              <li><a href="{{route('examseries.create')}}"><i class="material-icons-outlined">arrow_right</i>Add Exam series</a>
              </li>
              <li><a href="{{ route('examquestion.list') }}"><i class="material-icons-outlined">arrow_right</i>Question</a>
              </li>
              <li><a href="{{route('examquestion.create')}}"><i class="material-icons-outlined">arrow_right</i>Add Question</a>
              </li>
