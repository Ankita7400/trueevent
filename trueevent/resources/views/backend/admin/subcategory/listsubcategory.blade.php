...
<li class="breadcrumb-item active" aria-current="page">Service Sub Categories</li>
</ol>
</nav>
</div>
<div class="ms-auto">
<div class="btn-group">
<a href="{{route('admin.sub-categories.create')}}" class="btn btn-primary">Add Sub Categories</a>
...
<td> <img src="{{asset('public/'.$subcategory->image ?: 'public/backend/assets/img/default.png') }}"  class="rounded-circle m-r-5"  width="28" height="28" > 

</td>
   <td>{{ $subcategory->status ? 'Active' : 'Inactive' }}</td>
<td>
    
<a class="p-2 text-success" href="{{ route('admin.sub-categories.edit', $subcategory->id) }}">Edit</a>
...
@csrf
@method('DELETE')
<a href="{{ route('admin.sub-categories.destroy', $subcategory->id) }}" class="p-2 text-danger" onclick="return confirm('Are you sure you want to delete this Course ?')">Delete</a>
</form> 
</td>
</tr>
@endforeach
