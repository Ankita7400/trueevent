...
<div class="breadcrumb-title pe-3">Update Service Categories</div>
<div class="ps-3">
<nav aria-label="breadcrumb">
<ol class="breadcrumb mb-0 p-0">
<li class="breadcrumb-item"><a href="javascript:;"><i class="bx bx-home-alt"></i></a>
</li>
<li class="breadcrumb-item active" aria-current="page">Update Service Categories</li>
...
<input type="text" class="form-control  @error('name') is-invalid @enderror" placeholder="Enter Categories Name" name="name" value="{{ $subcategory->name }}">
@error('title')
...
<input type="text" class="form-control @error('slug') is-invalid @enderror" id="slug" placeholder="slug" name="slug"  value="{{ $subcategory->slug }}" >
 @error('slug')
  <div class="invalid-feedback">{{ $message }}</div>
  @enderror
</div>
...
<div class="col-12 mt-3">
  ...
  <div class="row">
      ...
      <div class="col-md-3 position-relative preview-image">
          <img src="{{ asset('public/'.$subcategory->image) }}" class="img-thumbnail mb-2" style="max-width: 100%;">
          <button type="button" class="btn btn-danger btn-remove-existing position-absolute top-0 end-0" data-id="{{ $subcategory->id }}">X</button>
      </div>
      {{-- @endforeach --}}
  </div>
</div>
