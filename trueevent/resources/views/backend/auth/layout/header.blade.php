...
<head>
<meta charset="utf-8">
<title>TrueEvent</title>
<meta name="viewport" content="width=device-width, initial-scale=1.0, user-scalable=0">

<!-- Favicons -->
{{-- <link href="{{asset('public/backend/assets/img/logo/favicon.png')}}" rel="icon"> --}}
...
<img src="{{asset('public/backend/assets/img/logo/logo.png')}}" class="img-fluid" alt="Logo" height="100" width="100">
</a>
</div>
